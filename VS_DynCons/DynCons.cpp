...
#pragma comment(lib, "C:\\Users\\admin\\Desktop\\LR1_Ivanov\\VisualStudio\\DynCons\\x64\\Debug\\DLL.lib") //автоматически залинкует библиотеку
#include <iostream>
#include "windows.h"
#include <tchar.h>
...
{   
    ...
    hLib = LoadLibrary(L"C:\\Users\\admin\\Desktop\\LR1_Ivanov\\VisualStudio\\DynCons\\x64\\Debug\\DLL.dll");
    if (hLib == NULL)
    {
